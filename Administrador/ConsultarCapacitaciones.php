                            ...
                            <div class="panel-body">
                                <div class="dataTable_wrapper">
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                        <?php 
                                            $prep_state = $admin->ConsultarCapacitaciones();
                                            while ($row = $prep_state->fetch(PDO::FETCH_ASSOC)){
                                        ?>
                                            <tr>                 
                                                <td><?php echo $row['nombretamp'];?></td>                                   
                                                <td><?php echo $row['rcp'];?></td>                                    
                                                <td><?php echo $row['acls'];?></td>
                                                <td><?php echo $row['prntraumaetm'];?></td>
                                                <td><?php echo $row['phtls'];?></td>
                                                <td><?php echo $row['peep'];?></td>
                                                <td><?php echo $row['pals'];?></td>
                                                <td><?php echo $row['nals'];?></td>
                                                <td><?php echo $row['empact'];?></td>
                                                <td><?php echo $row['amls'];?></td>
