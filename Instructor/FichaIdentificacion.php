        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h1 class="page-header">Ficha de Identificacion</h1>
                    </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <fieldset <?php echo $sin; ?> >
                            <center><h3>La Ficha de identificacion es necesaria para crear/impartir un curso</h3></center>
                        ...
                        <fieldset <?php echo $con; ?> >
                            ...
                            <center>
                                ...
                                <a href="VerFichaIdentificacion.php" class="btn btn-success">Ver ficha de identificacion</a>    
