        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h1 class="page-header">Eliminar Alumno  </h1>
                    </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        ?>
                            <form method='post'>
                                ...
                                <a href='VerAlumnoCurso.php' class='btn btn-default' role='button'>No</a>
                        ...
                        <?php  ?> 
                            <form action="MiCurso.php" method="POST"> 
                                ...
                                <button type="submit" class="btn btn-large btn-primary">Regresar a Curso :(</button> 
