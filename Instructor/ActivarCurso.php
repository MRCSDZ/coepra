...
if (isset($_POST['cam-btn'])) 
{
    ...
    $curso->ActivarCurso();
    header("Location: ActivarCurso.php?activado");
}
      
      if(isset($_GET['activado'])){
         $Mensaje = "<div class=\"alert alert-success alert-dismissable\">
                            <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\">&times</button>
                            El curso fue Activado.
                        </div>";
      }
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h1 class="page-header">Activacion de Curso  </h1>
                    </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        ?>
                            <form method='post'>
                                ...
                                <div class='alert alert-warning'>Estas seguro que quieres Reactivar el Curso?"</div>
