...
if (isset($_POST['del-btn'])) 
{
    ...
    $curso->EliminarCurso();
    header("Location: EliminarMiCurso.php?Eliminado");
}
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h1 class="page-header">Eliminar Mi Curso </h1>
                    </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        ?>
                            <form method='post'>
                                ...
                                <div class='alert alert-warning'>¿Estas seguro que quieres Eliminar el Curso?, Se eliminara todo el contenido
                                como alumnos, direcciones, evidencias y datos generales.</div>
