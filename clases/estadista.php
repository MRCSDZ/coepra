...
class Estadista
	{	public $db_conn;
		...
		public $cantidadfichas;
		public $cantidadtamp;
		public $cantidadhospitales;
		public $cantidadambulancias;
		...
		function CantidadTotalCursos()
    	{
	        ...
	        $this->cantidadcursos = $row['CantidadTotal'];


    	}

    	function CantidadTotalAlumnos()
    	{
	    	$sql = "SELECT COUNT(idalumno) as CantidadTotal
	    			FROM alumno";
	        ...
	        $this->cantidadalumnos = $row['CantidadTotal'];


    	}

    	function CantidadTotalFichas()
    	{
	    	$sql = "SELECT COUNT(idfichaidentificacion) as CantidadTotal
	        ...
	        $this->cantidadfichas = $row['CantidadTotal'];


    	}

    	function CantidadTotalTAMPS()
    	{
	    	$sql = "SELECT COUNT(idtamp) as CantidadTotalUsuarios
	    			FROM tamp";
	        ...
	        $this->cantidadtamp = $row['CantidadTotalUsuarios'];


    	}

    	function CantidadTotalHospitales()
    	{
    	...
    	function CantidadTotalAmbulancias()
    	{
