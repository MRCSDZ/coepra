                        ...
                        <div class="col-lg-6">
                            ...
                            -->
                                ...
                                <select name="rcp" id="" class="form-control">
                                    <option value="RCP Para Profesionales">Si</option>
                                ...
                                <select name="naetm" id="" class="form-control">
                                    <option value="PR en Trauma NAEMT">Si</option>
                                    <option value="">No</option>
                                </select>
                                <br>
